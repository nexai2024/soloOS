...
import { Rocket, Mail, Lock, Moon, Sun, AlertCircle, Loader2 } from 'lucide-react';
...
export default function LoginForm({ onSignupClick, onBack }: LoginFormProps) {
